	...
	*new { | out |
	...
	init { | out |
		...
		controlspecs = Dictionary.newFrom([
			...
			\01, Dictionary.newFrom([\amp, ControlSpec.new(minval: 0.0, maxval: 1.0, warp: 'lin', step: 0.0, default: 0.65)]),
			\02, Dictionary.newFrom([\carAtk, ControlSpec.new(minval: 0.001, maxval: 10, warp: 'exp', units: 's', default: 0)]),
			\03, Dictionary.newFrom([\carRel, ControlSpec.new(minval: 0.001, maxval: 10, warp: 'exp', units: 's', default: 0.43)]),
			\04, Dictionary.newFrom([\modAmp, ControlSpec.new(minval: 0, maxval: 1, warp: 'lin', default: 0.32)]),
			\05, Dictionary.newFrom([\modHz, ControlSpec.new(minval: 20, maxval: 24000, warp: 'exp', units: 'hz', default: 180)]),
			...
			\10, Dictionary.newFrom([\modRel, ControlSpec.new(minval: 0.001, maxval: 10, warp: 'exp', units: 's', default: 0.2)]),
			\11, Dictionary.newFrom([\feedAmp, ControlSpec.new(minval: 0, maxval: 1, warp: 'lin', default: 1)]),
			\12, Dictionary.newFrom([\rampDepth, ControlSpec.new(minval: 0, maxval: 1, warp: 'lin', default: 0.3)]),
			\13, Dictionary.newFrom([\rampDec, ControlSpec.new(minval: 0.001, maxval: 10, warp: 'exp', units: 's', default: 0.06)]),
			...
			\24, Dictionary.newFrom([\lpRel, ControlSpec.new(minval: 0.001, maxval: 10, warp: 'exp', units: 's', default: 0.3)]),
	...
	trigger {
		if( params[\poly] == 0,{
			...
			Synth.new(\kildare_tm, params.getPairs, voiceGroup);
		},{
